...
export function prismaToFrontend(prismaReport: PrismaPSIRReport): PSIRReport {
  return {
    ...
    identifyingData: {
      ...
      trueName: prismaReport.trueName || '',
      ...
      letterJudge: prismaReport.letterJudge || prismaReport.presentOffenseJudge || '',
      letterCourt: prismaReport.letterCourt || prismaReport.presentOffenseCourt || '',
      letterPosition: prismaReport.letterPosition || '',
...
export function frontendToPrisma(frontendReport: Partial<PSIRFormData>): any {
  ...
  return {
    ...
    letterJudge: id?.letterJudge,
    letterCourt: id?.letterCourt,
    letterPosition: id?.letterPosition,
